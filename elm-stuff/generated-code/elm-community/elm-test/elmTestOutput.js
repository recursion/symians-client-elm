...
var _user$project$World_Models$initLocation = {
	entities: {ctor: '[]'},
	type_: '',
	selected: false
};
var _user$project$World_Models$Model = F2(
	function (a, b) {
		return {locations: a, dimensions: b};
	});
var _user$project$World_Models$Dimensions = F3(
	function (a, b, c) {
		return {length: a, width: b, height: c};
	});
var _user$project$World_Models$init = {
	locations: _elm_lang$core$Dict$empty,
	dimensions: A3(_user$project$World_Models$Dimensions, 0, 0, 0)
};
var _user$project$World_Models$Location = F3(
	function (a, b, c) {
		return {entities: a, type_: b, selected: c};
	});
var _user$project$World_Models$Coordinates = F3(
	function (a, b, c) {
		return {x: a, y: b, z: c};
	});

var _user$project$World_Coordinates$extract = function (asString) {
	...
	return A3(
		_user$project$World_Models$Coordinates,
		extract_(0),
		extract_(1),
		extract_(2));
};
var _user$project$World_Coordinates$hash = function (coords) {
	return A2(
		_elm_lang$core$String$join,
		'|',
		{
...
var _user$project$World_CoordinatesTest$all = A2(
	...
	'A Test Suite',
	{
		...
		_0: A2(
			...
			'Is a record of ints x, y, z',
			function (_p0) {
				var coordinates = A3(_user$project$World_Models$Coordinates, 5, 5, 5);
				return A2(
		...
		_1: {
			...
			_0: A2(
				_elm_community$elm_test$Test$test,
				'hash: returns a string of | seperated coords',
				function (_p1) {
					var hashed = _user$project$World_Coordinates$hash(
						A3(_user$project$World_Models$Coordinates, 5, 5, 5));
					return A2(_elm_community$elm_test$Expect$equal, hashed, '5|5|5');
				}),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_community$elm_test$Test$test,
					'extract: turns a hashed string of coords into a set of coordinates',
					function (_p2) {
						var extracted = _user$project$World_Coordinates$extract('5|5|5');
						return A2(
							_elm_community$elm_test$Expect$equal,
							extracted,
							A3(_user$project$World_Models$Coordinates, 5, 5, 5));
...
var _user$project$Test_Generated_Main3870951952$main = A2(
	...
	_elm_community$elm_test$Test$concat(
		{
			...
			_0: A2(
				_elm_community$elm_test$Test$describe,
				'World.CoordinatesTest',
				{
					ctor: '::',
					_0: _user$project$World_CoordinatesTest$all,
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
...
Elm['Test']['Generated']['Main3870951952'] = Elm['Test']['Generated']['Main3870951952'] || {};
if (typeof _user$project$Test_Generated_Main3870951952$main !== 'undefined') {
    _user$project$Test_Generated_Main3870951952$main(Elm['Test']['Generated']['Main3870951952'], 'Test.Generated.Main3870951952', undefined);
}
